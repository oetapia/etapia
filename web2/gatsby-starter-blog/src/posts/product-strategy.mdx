...
*e.g. South Korea's exports compose ~70% of GDP. Their main industries are machinery {Doosan, Hyundai}, Semiconductors {SK Hynix, Samsung}, Vehicles {Hyundai, Kia}, Ships {DSME. Hyundai}, Electronics {Samsung, LG}, Chemicals {Lotte}, Culture {CJ, Naver}*

#### Social structure
We need to see how society is structured, what degree of freedom they have, how it is enforced, if there's control from the government side or from the people themselves. 


*e.g. Although half the country has no specified religion, the other hald have are adept Christians, Protestants, and Buddhists. However society is highly organized by Confucianism. Which aligns with a  social contract that has higher power than the government. Civilians police each other so less force is needed from the police*
...
*e.g. South Korea has been following the devlopment path of Japan and admires the US in multiple senses. Families encourage the young to study in American Universities, companies look for inspiration in Silicon Valley and people consume American Culture. Their objectives are to become a highly developed Westernized nation, but their fears are losing their own values, so a lot of localization happens to products and services*


#### Actual needs
Necessities are considered based on the context of the user. Commodities such as shoes are attributed a secondary characteristic that helps to demonstrate personality traits (stylish, knowledgeable), professionalism (dedicated shoes for a specific sport), and social status (luxury). 
